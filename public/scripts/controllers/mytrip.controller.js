app.controller('MyTripController', ['MyTripFactory', '$http', 'AuthFactory', function(MyTripFactory, $http, AuthFactory) {
...
console.log('mealTypes', self.mealTypes);
...
self.deleteTrip = function(tripID) {
    myTripFactory.deleteTrip(tripID)
        .then(function(response) {
                myTripFactory.deleteDays(tripID)
                    .then(function(response) {
